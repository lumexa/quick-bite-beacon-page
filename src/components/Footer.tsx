        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Delicious food, delivered fast. Serving quality meals since 2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Chicken</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Sides</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Drinks</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Email: info@quickbite.com</li>
              <li className="text-gray-400">Phone: (555) 123-4567</li>
              <li className="text-gray-400">Address: 123 Main Street</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">© {new Date().getFullYear()} QuickBite. All rights reserved.</p>
